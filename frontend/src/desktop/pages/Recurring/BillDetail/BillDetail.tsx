...
export const BillDetail = ({ bill }: BillDetailProps): JSX.Element => {
  ...
  // Recurring route ever populates it — a user landing here without having visited
  ...
  const availableTx = transactions.filter(
    (t) =>
      !t.bill_id &&
          ...
          <Tabs.Content value="history" className={styles.sectionPadding}>
            {billHistory.loading ? (
              ...
              <Flex direction="column" gap="1">
                {billHistory.transactions.map((tx) => (
