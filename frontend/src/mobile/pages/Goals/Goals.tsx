...
const goalIcons: Record<string, JSX.Element> = {
  save_up: <PiggyBank size={16} />,
  pay_down: <TrendingDown size={16} />,
  monthly_envelope: <Target size={16} />,
}
                ...
                <Flex direction="column" gap="2">
                  <Flex align="center" justify="between">
                    <Flex align="center" gap="2">
                      {goalIcons[goal.type] || <Target size={16} />}
                      <Heading size="3">{goal.name}</Heading>
                      <Badge color={achieved ? 'green' : 'gray'} size="1">
